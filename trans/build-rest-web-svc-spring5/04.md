...
在这一章中，我们将在 Spring5 中完成基本的**创建**、**读取**、**更新**和**删除**（**积垢**）API。在本章之后，您将能够在 Spring5 中使用反应堆支持进行简单的 CRUD 操作。
...
![](Images/82cd10d5-7c5a-445d-9586-4ad49159212a.png)
...
![](Images/523cfdae-1c96-4847-bd10-03d5528e29b8.png)
...
![](Images/df51fdd2-5775-4372-b8a4-8db654b3a0ff.png)

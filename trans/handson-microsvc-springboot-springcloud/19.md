...
在本节中，我们将模拟一个错误，并查看如何找到有关它的信息，一直到在系统环境中的一个微服务中导致错误的源代码行。为了模拟错误，我们将在*添加可编程延迟和随机错误*部分中重用[第 13 章](13.html)中介绍的故障参数*使用Resilience4j*提高弹性。我们可以使用此命令强制产品微服务引发异常。请执行以下步骤：

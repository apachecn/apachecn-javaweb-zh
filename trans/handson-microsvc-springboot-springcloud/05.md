...
![](Images/4b24888c-15c8-42ed-8f85-99bff144857c.png)
...
# 向产品组合服务应用程序添加配置和通用 API 文档

要在`product-composite-service`微服务中启用 SpringFox，我们必须添加一个配置。为了保持源代码紧凑，我们将直接将其添加到`ProductCompositeServiceApplication`应用程序类中。
...
![](Images/eb92fdb1-5db9-4a87-92d4-7c71147b6608.png)
...
![](Images/8cfce8b6-7453-449a-a9ef-2e09eaa283fa.png)

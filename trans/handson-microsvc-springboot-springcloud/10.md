# 使用 SpringCloudGateway 在边缘服务器后面隐藏微服务
...
![](Images/3ec7ce9c-d8a1-48bd-a0af-932a2b44ed6b.png)
...
2.  主应用程序类`se.magnus.springcloud.gateway.GatewayApplication`声明了一个`WebClient.builder`bean，用于健康指示器的实现，如下所示：
...
从前面的源代码中，我们可以看到，`WebClient.builder`用`@LoadBalanced`注释，这使得它知道在发现服务器 Netflix Eureka 中注册的微服务实例。详见[第 9 章](09.html)中*与 Netflix Eureka 在春云中的服务发现*一节*使用 Netflix Eureka 和 Ribbon 添加服务发现*。
...
![](Images/fa1b108b-8607-4ced-a8b6-b24fc43ce34d.png)
...
![](Images/635db56b-5896-497a-a15d-2ca63833a1e8.png)
...
![](Images/7e1c7cfb-3eb6-4299-9199-b4415b1b20b3.png)
...
![](Images/20e4c6a4-4714-4990-b85f-964445d04b6a.png)
...
![](Images/d8b40a4a-a897-408e-9131-8dd8b7f52041.png)

请注意，边缘服务器（名为`gateway`）也存在于响应中。

3.  接下来，使用 URL`http://localhost:8080/eureka/web`在 web 浏览器中打开 Eureka 网页：

![](Images/c1f75e90-3c3a-42c1-aac1-432c7428230e.png)

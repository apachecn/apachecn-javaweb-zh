...
随着针对应用的漏洞攻击的发展，SpringSecurity也必须随之发展。在一个主要的发布版本中，SpringSecurity团队抓住机会进行了一些非被动的更改，重点是以下几点：

*   默认情况下确保 SpringSecurity更安全（[https://www.owasp.org/index.php/Establish_secure_defaults](https://www.owasp.org/index.php/Establish_secure_defaults) ）
...
SpringSecurity团队创建了一个示例项目，演示了从 3.x 迁移到 4.x 时的所有更改，并在 GitHub 上提供了该项目。

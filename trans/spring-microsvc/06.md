...
在[第 5 章](05.html "Chapter 5. Scaling Microservices with Spring Cloud")*使用 Spring Cloud 扩展微服务*中，您学习了如何使用 Spring Cloud 组件扩展 Spring Boot 微服务。我们实现的 SpringCloud的两个关键概念是自注册和自发现。这两种功能支持自动化微服务部署。通过自注册，只要实例准备好接受流量，微服务就可以通过向中央服务注册中心注册服务元数据来自动公布服务可用性。一旦注册了微服务，消费者就可以通过使用注册表服务发现服务实例，从下一刻开始使用新注册的服务。注册表是这种自动化的核心。

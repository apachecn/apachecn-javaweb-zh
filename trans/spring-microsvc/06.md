...
![Reviewing the microservice capability model](graphics/B05447_6_1.jpg)
...
![Scaling microservices with Spring Cloud](graphics/B05447_6_2.jpg)
...
![Understanding the concept of autoscaling](graphics/B05447_6_3.jpg)
...
![The benefits of autoscaling](graphics/B05447_6_4.jpg)
...
*   **It gives priority to certain services or group of services**: With autoscaling, it is possible to give priority to certain critical transactions over low-value transactions. This will be done by removing an instance from a low-value service and reallocating it to a high-value service. This will also eliminate situations where a low-priority transaction heavily utilizes resources when high-value transactions are cramped up for resources.
    ...
    ![The benefits of autoscaling](graphics/B05447_6_5.jpg)
...
![Autoscaling an application](graphics/B05447_6_6.jpg)
...
![Autoscaling the infrastructure](graphics/B05447_6_7.jpg)
...
![Scaling with resource constraints](graphics/B05447_6_8.jpg)
...
![Scaling during specific time periods](graphics/B05447_6_9.jpg)
...
![Scaling based on the message queue length](graphics/B05447_6_10.jpg)
...
![Scaling based on business parameters](graphics/B05447_6_11.jpg)
...
![The capabilities required for an autoscaling system](graphics/B05447_6_12.jpg)
...
![Understanding the deployment topology](graphics/B05447_6_13.jpg)
...
![Understanding the execution flow](graphics/B05447_6_14.jpg)
...
1.  Create a new Spring Boot application and name it `chapter6.lifecyclemanager`. The project structure is shown in the following diagram:
    ...
    ![A walkthrough of the life cycle manager code](graphics/B05447_6_15.jpg)

    该示例的流程图如下图所示：

    ![A walkthrough of the life cycle manager code](graphics/B05447_6_16.jpg)
...
8.  Open the Eureka console (`http://localhost:8761`) and watch for a second **SEARCH-SERVICE**. Once the server is started, the instances will appear as shown here:
    ...
    ![Running the life cycle manager](graphics/B05447_6_17.jpg)

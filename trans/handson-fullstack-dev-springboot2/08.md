...
![](Images/f994a30d-033c-4a6a-a3be-1d1b9ec22336.png)
...
![](Images/b1d661a3-734f-4496-af43-f35249f99835.png)

单击组件链接以查看有关组件的更多详细信息。通常，您可以在那里找到安装说明以及一些如何使用该组件的简单示例。信息页面通常提供组件网站或 GitHub 存储库的地址，您可以在其中找到完整的文档：

![](Images/cf6b1ef2-f13a-4cc4-a661-b08087c54ecb.png)
...
![](Images/0856b3ab-d105-43ee-bef5-255de4baf67b.png)

现在，如果您将 React 应用程序源代码推送到 GitHub，则不应包含`node_modules`，因为该文件夹非常大。`create-react-app`包含`.gitignore`文件，该文件将`node_modules`文件夹从存储库中排除。`.gitignore`文件的内容如下所示：
...
![](Images/23376f91-4b30-4a06-9879-499da8c4f3ab.png)
...
![](Images/608986ae-592d-44f8-9fd7-42390b471a3e.png)
...
![](Images/84d1aae2-eb68-4223-9266-3a6715e609cc.png)
...
![](Images/7a8d772a-6ae4-433a-809b-6c9ef2dfc910.png)

按下“添加项目”按钮时，模式窗体打开：

![](Images/40899635-da48-4bb4-9e43-4efa66de2624.png)

在输入框中键入一些值，然后按“添加”按钮。模式窗体已关闭，并且可以在列表中看到新项：

![](Images/c0a470fd-74c3-40d0-8e8c-36dbe27acdf6.png)
...
现在应用程序正在使用`RaisedButton`，看起来是这样的：

![](Images/9bd9c0fb-64a3-451d-abe3-4e875b490adb.png)
...
![](Images/ac8e042d-fe61-4654-9c1e-6f55e9e370fe.png)
...
![](Images/8dbdd374-f4e9-4c2b-bca5-05f0f3a0943d.png)

# 路由

React 中有多种路由解决方案。我们正在使用的最流行的是 React 路由器（[https://github.com/ReactTraining/react-router](https://github.com/ReactTraining/react-router) 。对于 web 应用程序，React Router 提供了一个名为`react-router-dom`的包。
...
![](Images/dc6583d7-4b81-4746-a4d5-a1c1d4188a4e.png)

当按下触点链接时，`Contact`组件被渲染：

![](Images/1f11cf3a-14b9-48bd-bfee-a5e4dc0a178a.png)

...
![](Images/db4abdaa-1fcf-4e52-928d-76b55ab1a1a6.png)

4.  我们将我们的包裹命名为`com.packt.cardatabase.domain`：

![](Images/1a9b38e4-f800-4008-b706-12f225121521.png)

5.  接下来，我们创建实体类。激活一个新实体包，右键单击，然后从菜单中选择新建|类。因为我们要创建一个 car 数据库，实体类的名称是`Car`。在名称字段中键入`Car`，然后按下完成按钮：

![](Images/8fe3af1e-49e2-480e-8e33-ba06ffa7429e.png)
...
![](Images/5ea5f7d7-c3d8-45c4-a545-1fd6b27b0c94.png)
...
![](Images/54d517da-1a8d-4868-9a48-4853231caafe.png)

现在您可以在数据库中看到我们的`car`表。您可能会注意到，寄存器编号在单词之间有一个下划线。这是由于属性（`registerNumber`的大小写命名导致的：

![](Images/f8de2f11-fdfe-4ca4-9128-acb7e19e414c.png)
...
![](Images/9eb6f592-c706-4423-9ac2-229f78df8ed1.png)

您还可以使用 H2 控制台从数据库中获取车辆，如以下屏幕截图所示：

![](Images/022a3422-30f9-449a-8c37-ec146b27ffc4.png)
...
![](Images/97ade669-bf1f-4f12-bdec-5fe34cf5d487.png)
...
![](Images/6f219664-b827-48a6-974a-789cac7ba8df.png)

现在，我们的域包包含两个实体类和存储库：

![](Images/0aac2b0d-6e2e-447a-a717-9de4535894c4.png)
...
![](Images/65c81d66-5d5c-4226-97d8-3cc6cd3ec050.png)
...
![](Images/13e22a64-525c-4c56-8c71-1352688039b9.png)
...
![](Images/586b87e4-1b95-4af1-b41d-9e95b1440794.png)
...
![](Images/bc77682b-cdf2-4ded-87cc-11e37a6790d8.png)

3.  让我们把我们的数据库命名为`cardb`。按“确定”后，您会在数据库列表中看到新的`cardb`：

![](Images/a92e8240-513d-4ce7-bdfe-c4b20b8441be.png)
...
![](Images/13b4481b-9fd1-4995-9b3c-51bf2e2af457.png)

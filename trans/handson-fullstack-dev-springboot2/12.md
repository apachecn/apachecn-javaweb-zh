...
![](Images/84990f7e-069e-4734-8e76-798df3aaa5d0.png)
...
![](Images/fa09273d-48c7-4531-8a20-3ed6975966d8.png)
...
![](Images/0f151a12-c3ae-4faa-a38c-9aecd4337028.png)

第一次执行测试时，会创建一个`_snapshots_`文件夹。此文件夹包含从测试用例生成的所有快照文件。现在，您可以看到生成了一个快照文件，如以下屏幕截图所示：

![](Images/eb52cf51-488f-46e4-8d63-13edc8e597a7.png)
...
![](Images/42d35766-4774-4990-9b63-0f46415c4de0.png)

...
在本章中，我们首先探讨 DI 的需求。我们使用一个简单的例子来说明 DI 的使用。我们将了解 DI 的重要优势——更容易维护、更少耦合和更好的可测试性。我们将在Spring探索 DI 选项。在本章的结尾，我们将介绍 Java**上下文和依赖注入**（**CDI**）的标准 DI 规范，以及 Spring 如何支持它。

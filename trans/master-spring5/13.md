...
Kotlin 是一种开源的静态类型语言，可用于构建在 JVM、Android 和 JavaScript 平台上运行的应用程序。Kotlin 由 JetBrains 根据 Apache 2.0 许可证开发，源代码可在 GitHub（[上获得 https://github.com/jetbrains/kotlin](https://github.com/jetbrains/kotlin) ）。
...
Kotlin 表达力强、简洁、可扩展、功能强大，读写都很有趣。它在可空性和不变性方面具有出色的安全特性，这与我们的投资相一致，使 Android 应用程序在默认情况下保持健康和性能。最重要的是，它可以与我们现有的 Android 语言和运行时进行互操作。

关于 Kotlin 的一些重要事项包括：

*   与 Java 完全兼容。您可以从 Kotlin 调用 Java 代码，反之亦然。
*   简明易读的语言。科特林常见问题解答（[http://kotlinlang.org/docs/reference/faq.html](http://kotlinlang.org/docs/reference/faq.html) 估计代码行数会减少 40%。
*   支持函数式和面向对象编程。
...
科特林的类型系统旨在消除`NullPointerException`。普通变量不能为 null。如果未注释，则不会编译以下代码段：
...
![](assets/b93380e9-2943-4ce5-b46e-973ac528b33e.png)

选择 Kotlin Plugin for 并单击确认按钮，如以下屏幕截图所示：

![](assets/2139b4b7-0889-4353-a10d-398c3accefbe.png)
...
![](assets/5f18bf5b-a5d6-4bca-8eab-1cfe7e0f9270.png)

从列表中选择 Kotlin 项目。

![](assets/51bcf051-0838-4411-a6dc-b8dac1ccfd91.png)
...
![](assets/e1bd36af-0e46-426a-a16d-1ab3ad758d36.png)

# 创建 Kotlin 类

要创建新的 Kotlin 类，请右键单击文件夹并选择 new | Other，如以下屏幕截图所示：

![](assets/0e186fae-c3a4-4c30-9c5d-58a9fa90b84f.png)

选择类，如以下屏幕截图所示：

![](assets/bb0aea9a-4351-4d8f-b4d8-4014c9895b7b.png)

为您的新 Kotlin 类指定一个名称（`HelloWorld`和一个包（`com.mastering.spring.kotlin.first`。点击 Finish。

![](assets/a10bb0f4-49ab-4969-9a6e-17019abccf64.png)
...
![](assets/e4dfc644-e384-4066-a4a8-28bd7ae73ac0.png)

`Hello, World`打印在控制台上，如下图：

![](assets/76ed30ae-1f51-4b3c-8467-a8984927b92a.png)
...
![](assets/1be0b859-4870-4de0-b102-593490b7e0a1.png)
...
![](assets/8a0f2fa3-5f2f-48c7-b111-0462a0805d40.png)
...
除了 Java Spring 引导项目中的正常依赖项之外，`pom.xml`中还有两个额外的依赖项
...
通过将`FirstWebServiceWithKotlinApplication`作为 Kotlin 应用程序运行，可以启动该应用程序。
...
![](assets/72ba2bc4-82eb-484d-8120-a8b02f17a8e7.png)
...
*   `fun `GET welcome returns "Hello World"`()`：这是科特林的一大特色。我们给出的不是测试方法的名称，而是测试的描述。这非常棒，因为在理想情况下，测试方法不会从另一个方法调用。
...
![](assets/99cedfa7-f5c9-400a-be14-75aa25236fee.png)
...
![](assets/b122ca61-e936-420f-aa17-faa7369dbb9d.png)
...
Kotlin 帮助开发人员编写简洁易读的代码。它与 Spring Boot 的理念相契合，使应用程序开发更容易、更快。

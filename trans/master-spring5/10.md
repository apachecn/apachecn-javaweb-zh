...
![](assets/e4e968de-1d77-43b1-bd60-0ce412b12ac0.png)
...
![](assets/1ef4605f-eba9-4a16-b50c-6be64bf87b15.png)

另一个示例场景涉及由多个应用程序使用的事件。例如，当客户注册时，我们希望向他们发送电子邮件、欢迎工具包和邮件。此场景的简单消息传递体系结构如下图所示：

![](assets/d1fa3516-aa1e-4224-a9eb-2d92f5b566c8.png)
...
![](assets/4a31fe0b-fb4e-420d-9a05-a11cdff9254a.png)
...
![](assets/07fb81a0-b47c-43c0-91de-bf6dedf0db93.png)
...
![](assets/60d12ed9-8204-48cf-a89f-6c162c9e5427.png)
...
![](assets/077ee2c6-bf62-4989-824f-c19fb814bed1.png)
...
![](assets/fc3c5ba3-ba93-471c-baf6-5189345a510c.png)

您可以尝试使用“help”命令来获取支持的命令列表。以下屏幕截图显示了执行`help`命令时打印的一些命令：

![](assets/3593bc81-bec4-4e65-8a50-c3637dcce671.png)
...
在我们使用 Spring Cloud Stream 创建的所有三个应用程序上运行`mvn clean install`：
...
![](assets/c6e3de16-73b2-40f4-9082-5cc2b80f568c.png)

我们还可以使用仪表板注册应用程序，如以下屏幕截图所示：

![](assets/15363632-47c4-45e1-822d-cf56cbe4ba9e.png)
...
![](assets/bbeb68d5-8170-4ce3-8230-3559120b0a4c.png)
...
![](assets/317bf00f-c9e2-4511-b441-bbe455c25296.png)
...
这些命令与我们之前创建的用于注册流应用程序的命令非常相似。我们正在添加一个任务定义，以便能够执行该任务。

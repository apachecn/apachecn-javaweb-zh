...
![](assets/51cba3ab-d570-4eb9-a226-3c27456647af.png)
...
![](assets/dfce5d48-ef55-4393-9a25-e6c695125f13.png)
...
![](assets/3c9a0fb3-d07a-4b93-8a02-50c3d01812f7.png)

下面的屏幕截图显示了 POST 服务在 Swagger UI 中为用户创建`todo`的详细信息：

![](assets/c29b7ef2-eb45-4e26-9310-cfb09e9f0950.png)
...
![](assets/579ca5d7-bcc6-4814-8079-65b2b715a312.png)
...
![](assets/d5c2d818-4bee-47bc-a05f-73b94568d12d.png)

以下屏幕截图显示了如何将用户身份验证详细信息配置为 POST 参数的一部分：

![](assets/7bf1640a-be2f-4728-993b-9869b1f095bc.png)
...
![](assets/c549b7c3-2c0e-41ec-bf28-57580a2d3173.png)
...
![](assets/c66a5e37-0172-4460-a7d3-c17a862ae5ea.png)

返回来自`messages.properties`的默认消息。

下面的屏幕截图显示了使用`Accept-Language fr`调用前面的服务时的响应：

![](assets/6da4bb0b-3be3-4efd-bd29-0f7aee72b0a5.png)
...
`@EnableCaching`将在 Spring 引导应用程序中启用缓存。

...
Spring 集成（[http://projects.spring.io/spring-integration](http://projects.spring.io/spring-integration) 和弹簧反应器（[http://projectreactor.io](http://projectreactor.io) 也是我最喜欢的两个春季项目。

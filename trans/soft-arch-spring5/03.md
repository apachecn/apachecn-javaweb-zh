...
![](assets/a6ceedc9-69a8-4470-bb19-fdef34e6f985.png)
...
让我们通过运行以下`curl`命令来创建一个简单的 Spring 引导应用程序：
...
![](assets/58e57436-d3b0-4f60-9b5f-8ddb7a8ee74d.png)
...
我们有两个**bean**使用先前创建的存储库接口。第一个方法将运行，它将在表中插入两行。第二种方法将查询表中的所有行，然后在控制台中打印它们。运行此应用程序后，当应用程序启动时，您将在控制台中看到以下输出：
...
![](assets/9d79debc-84d7-4f68-8a8f-7ebd87f7d5ad.png)
...
![](assets/0f3e4098-f790-4fe1-951f-5820d1229695.png)
...
![](assets/23f3a241-caf4-48f7-be45-cb51f6e87c29.png)
...
![](assets/0429f36a-f799-4bc7-a1c8-45dbbb92e30a.png)

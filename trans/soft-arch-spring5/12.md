...
![](assets/54cd2652-036d-484f-80a0-6f85e5ec3ece.png)

我们将通过以下步骤继续此过程：

1.  选择监控应用程序并接受 14 天免费试用：

![](assets/791b2339-8423-4551-9197-520f2f4ebabf.png)

2.  选择 Java 应用程序选项：

![](assets/f823f831-4abe-4cc6-b023-036755c14777.png)

3.  生成许可证密钥并下载并安装代理。在这里，我们将在应用程序的根目录中创建一个文件夹名`newrelic`，并复制最近下载的 ZIP 的内容：

![](assets/da07a472-7cca-4175-b9cb-f718b6bbad83.png)

4.  我们现在将用我们的密钥许可证和应用程序名称替换`newrelic.yml`，如以下屏幕截图所示：

![](assets/2bfb8361-e0c0-4205-8ba1-38b837964ed2.png)
...
![](assets/28cc6220-22e5-442e-89f0-187686a21967.png)
...
![](assets/e8d633dd-5851-433e-b8e0-b29a61173975.png)

*   数据库指标：

![](assets/6bf3a771-e500-49cb-9d5d-0ebb20db3f77.png)

*   JVM 指标：

![](assets/76333a5a-d4ac-4c7b-a36c-dc211cf521bc.png)

*   网上交易：

![](assets/74538b32-fe33-473f-b116-97ded2ed4ae5.png)

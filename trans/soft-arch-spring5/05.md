...
![](assets/0396a5e1-c22c-4a1b-8c43-23e0f91f3043.png)
...
![](assets/b43675b9-a457-4b7c-a7ea-498fd0ead679.png)
...
![](assets/dad7ede6-b98c-4094-b684-939f57a30d17.png)
...
![](assets/98cc2f43-58d8-4774-ba84-3624b3095bf4.png)
...
![](assets/b206a811-4848-457e-9e13-199f9655a0ec.png)
...
![](assets/f775fbe3-e0a6-4894-82eb-af5a787e702f.png)
...
![](assets/9caf22ac-ecd6-4807-84a1-0bf87ae0062d.png)
...
![](assets/beb5e7a9-44a0-4193-90c2-eb28d15de1ba.png)
...
![](assets/bf74150a-6dcd-4e30-bddf-d45e3775f9d4.png)
...
我们在前面提到，Thymeleaf 根本不具有侵入性，我们将向您展示原因。一旦使用 Thymeleaf 标记实现了所有所需的逻辑，就可以使用常规浏览器再次打开模板，而无需在 servlet 容器中部署应用程序。您将得到以下结果：

![](assets/4575d939-9029-4f25-8eba-bfcbbe75a622.png)
...
![](assets/36c8691f-7520-44ff-926d-543720bf1767.png)
...
![](assets/cff6d101-4299-4113-980a-1bdf54daa13d.png)

地址栏中显示的挂锁

正如您在下面的屏幕截图中所看到的，HTTPS 协议使用的是`8443`端口，而不是用于 HTTP 的标准`80`：

![](assets/da4775b6-747a-4489-86b8-7c06a2f29c7e.png)
...
![](assets/a15cc8b0-106c-4136-abee-4ac95febbe38.png)

HTTPS 连接

位于中间的挂锁表示当它通过计算机网络时被加密的数据，这使得它不可能读取。以下屏幕截图显示了使用 Wireshark 截取数据时数据的外观：

![](assets/19bc0593-e13d-4981-85da-13041ff93ff1.png)
...
请注意，不应修改代码以在应用程序中启用 HTTPS

为了进行测试，可以使用密钥工具创建自签名证书，该工具是标准 Java 安装的一部分，如以下屏幕截图所示：

![](assets/6c5311c1-ec7b-4fee-bf15-ef64ef56e6a0.png)

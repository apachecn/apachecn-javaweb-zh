...
![](assets/8ddc799d-645a-4f18-b6ba-1a55ee131efb.png)
...
![](assets/a065abde-ec41-4828-ab21-9c8f33600082.png)
...
![](assets/c789f88c-e8ac-4e36-8e46-10290e86a8c9.png)
...
![](assets/dc5708c0-6293-4467-bfa9-dc7c7be9cf3d.png)
...
![](assets/b81c2556-b001-40b5-9827-887c498492a8.png)
...
![](assets/94465532-3b0f-4da2-816a-c233a82f9d2c.png)
...
![](assets/ee803ce8-493c-4991-9b50-5f7e8bdb2b73.png)
...
![](assets/f6c21ae3-3c05-481c-9dd0-bdad5e083381.png)

执行命令 A 后生成的事件和应用程序状态

下图显示了一个非常类似的过程。在本例中，由于`Command B`执行，创建了两个`Events`：

![](assets/ec22155e-8a04-4229-8737-b9c760246dfa.png)
...
![](assets/f60ed164-0460-4e56-b547-166613859f2a.png)

正在重建应用程序状态以处理所有事件

*   在恢复数据库快照后处理其余事件，并研究`Event b-1`执行期间的应用程序行为，如下图所示：

![](assets/f946d555-0508-4806-9395-bfc09324b89a.png)
...
![](assets/5fed95d8-d882-458b-95b7-a620e8cca665.png)
...
![](assets/81d1803c-8298-447b-8c39-f0c895be5c6b.png)
...
![](assets/6d25011b-0d29-4562-ae98-4001cb3b9e9a.png)

从科目表中查询结果

以下屏幕截图显示了查询客户表的结果：

![](assets/3b0f50a8-6983-46bb-aaf7-caef238a3c68.png)
...
![](assets/c07aa513-2d26-423b-a48a-81d0d1bb2d37.png)
...
![](assets/08280105-b441-4ee5-b9e8-7e9b1a1d03eb.png)
...
![](assets/7abf67f1-4d20-4321-a20c-9d332f8adaf3.png)

...
![Building the Task Log User Interface](graphics/5457OS_11_12.jpg)
...
![Task log workflows and layouts](graphics/5457OS_11_05.jpg)

从列表中选择任务日志项，将打开**编辑测试任务日志**表单中的记录。当列表显示时，任务日志表单中的**项目**下拉列表将显示除项目名称外的公司名称：

![Task log workflows and layouts](graphics/5457OS_11_02.jpg)

在此列表中选择**项目**将过滤**任务**组合框中显示的任务：

![Task log workflows and layouts](graphics/5457OS_11_03.jpg)

如果选择了没有分配任务的**项目**，则显示以下消息：

![Task log workflows and layouts](graphics/5457OS_11_04.jpg)

添加新任务日志将保留当前选择的**日期**和**项目**，如果存在：

![Task log workflows and layouts](graphics/5457OS_11_06.jpg)

删除任务日志将要求用户确认其操作：

![Task log workflows and layouts](graphics/5457OS_11_07.jpg)
...
![Building our task log views](graphics/5457OS_11_08.jpg)
...
![The ManageTaskLogs.js file](graphics/5457OS_11_09.jpg)
...
![The TaskLogForm.js file](graphics/5457OS_11_10.jpg)
...
![The TaskLogList.js file](graphics/5457OS_11_11.jpg)
...
![Testing the task log interface](graphics/5457OS_11_12.jpg)

尝试执行不返回任何记录的搜索。您应该看到在`TaskLogList`视图的`viewConfig`属性中定义的`emptyText`值：

![Testing the task log interface](graphics/5457OS_11_13.jpg)

现在，您可以尝试添加新记录并编辑现有任务日志，以测试全部功能。你能弹出下面的消息吗？

![Testing the task log interface](graphics/5457OS_11_14.jpg)

...
![3T Administration Made Easy](graphics/5457_12_01.jpg)
...
![Administration workflows and layouts](graphics/5457_12_02.jpg)

选择任务将显示**编辑任务**表单：

![Administration workflows and layouts](graphics/5457_12_03.jpg)

选择按钮**新增公司**按钮，显示空公司表单：

![Administration workflows and layouts](graphics/5457_12_04.jpg)

请注意，**删除**和**添加项目**按钮被禁用。当不允许操作时，所有屏幕中的相应按钮将被禁用。在这种情况下，无法将项目添加到尚未保存的公司。

树工具将允许用户展开、折叠和刷新树：

![Administration workflows and layouts](graphics/5457_12_05.jpg)

当用户首次显示管理界面时，显示**新增公司**画面。删除任何项目时，**请从树中选择一个项目…**消息显示：

![Administration workflows and layouts](graphics/5457_12_06.jpg)
...
![Building the 3T administration interface](graphics/5457_12_07.jpg)
...
![The CompanyTree.js file](graphics/5457_12_11.jpg)
...
![Introducing the Ext.data.TreeStore class](graphics/5457_12_08.jpg)
...
![Dynamically loading tree nodes](graphics/5457_12_09.jpg)

单击扩展器图标时，将动态加载下一级树：

![Dynamically loading tree nodes](graphics/5457_12_10.jpg)

然后可以展开第三级以显示任务：

![Dynamically loading tree nodes](graphics/5457_12_11.jpg)
...
![Displaying multiple tree columns](graphics/5457_12_12.jpg)
...
![Drag-and-drop made easy](graphics/5457_12_13.jpg)

...
![Encrypting/decrypting of SOAP messages](graphics/5825_07_02.jpg)

下图显示了用于加密/解密的公钥/私钥的用法。Bob 作为发送者，获取 Alice 的公钥，加密消息并将其发送给 Alice。因为只有她是自己私钥的持有者，所以她可以解密消息：

![Encrypting/decrypting of SOAP messages](graphics/5825_07_01.jpg)

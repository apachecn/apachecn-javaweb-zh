...
![Adding Custom Functionality to JPA Repositories](graphics/9045_04_01.jpg)
...
![What did we just do?](graphics/9045_04_02.jpg)
...
我们实现了一个通用的 delete 方法，该方法可自动用于应用程序的所有存储库。这消除了向服务层添加特定于实体的删除逻辑的需要，并减少了代码重复。我们还创建了一个自定义存储库工厂，该工厂提供`GenericBaseRepository`作为存储库接口的实现。我们的工作结果如下图所示：

![What did we just do?](graphics/9045_04_03.jpg)

...
![Installing Redis](graphics/9045_05_01.jpg)
...
最后一步是将使用过的 Redis 连接工厂 bean 的配置添加到我们的应用程序上下文配置类中。因为我们使用的是 RJC 连接器，所以正确的 Redis 连接工厂等级为`RjcConnectionFactory`。此类具有以下配置属性：
